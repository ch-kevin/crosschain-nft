...
import {WarppedKevinToken} from "./WarppedKevinToken.sol";
...
contract NFTPoolBrunAndMint is CCIPReceiver, OwnerIsCreator {
    ...
    constructor(address _router, address _link, address wnftAddr) CCIPReceiver(_router) {
        ...
        wnft = WarppedKevinToken(wnftAddr);
    }
